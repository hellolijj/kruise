...
func TestReconcile(t *testing.T) {
	...
	r := createReconcile(scheme, runtimeObj...)
...
func TestHttpProbe(t *testing.T) {
	...
	r := createReconcile(scheme, podPorbeMarker, pod)
...
func TestSyncStatus(t *testing.T) {
	...
	r := createReconcile(scheme, podPorbeMarker)
...
func createReconcile(scheme *runtime.Scheme, initObjs ...runtime.Object) ReconcilePodProbeMarker {
	...
	reconcile := ReconcilePodProbeMarker{
		Client: fakeClient,
		scheme: scheme,
	}
	return reconcile
