...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MarkProbe) DeepCopyInto(out *MarkProbe) {
	*out = *in
	in.Handler.DeepCopyInto(&out.Handler)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MarkProbe.
func (in *MarkProbe) DeepCopy() *MarkProbe {
	if in == nil {
		return nil
	}
	out := new(MarkProbe)
...
func (in *PodProbeMarkerSpec) DeepCopyInto(out *PodProbeMarkerSpec) {
	*out = *in
	...
	in.MarkerProbe.DeepCopyInto(&out.MarkerProbe)
	return
}
